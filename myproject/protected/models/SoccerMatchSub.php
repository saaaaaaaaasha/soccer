...
/**
 * This is the model class for table "{{soccer_match_sub}}".
 *
 * The followings are the available columns in table '{{soccer_match_sub}}':
 * @property integer $id
 ...
 */
class SoccerMatchSub extends CActiveRecord
{
	/**
	 ...
	 * @return SoccerMatchSub the static model class
	 */
