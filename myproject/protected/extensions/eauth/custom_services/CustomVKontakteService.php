	...
	protected function fetchAttributes() {
		$info = (array)$this->makeSignedRequest('https://api.vk.com/method/users.get.json', array(
			'query' => array(
				...
				'fields' => 'photo_200,first_name,last_name,nickname, sex, bdate, city, country, timezone, photo, photo_medium, photo_big, photo_rec',
			),
		));
				//var_dump($this);
		//var_dump($this->email);
		...
		$this->attributes['email'] = $this->email;//$info->email;
		...
		if (isset($info->photo_200)) $this->attributes['photo_200'] = $info->photo_200;
	}
}
